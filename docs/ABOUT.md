...
![Вкладка "Actions"](img/github_actions_setup__actions_tab.png)
...
![Зелёная кнопка согласия](img/github_actions_setup__workflow_button.png)
...
![Вкладка "Settings"](img/github_actions_setup__settings_tag.png)
...
![Security -> Secrets and variables -> Actions](img/github_actions_setup__action_secrets.png)

Нажмите на этот элемент списка и в правой части экрана вы увидите блок, который называется `Repository secrets`:

![Пустой Repository secrets](img/github_actions_setup__no_repository_secrets.png)
...
![Добавление нового секрета](img/github_actions_setup__new_repository_secret.png)
...
![Секрет успешно добавлен](img/github_actions_setup__added_repository_secret.png)
